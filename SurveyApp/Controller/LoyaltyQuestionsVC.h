...
@interface LoyaltyQuestionsVC : UIViewController<UIScrollViewDelegate,ASValueTrackingSliderDelegate>
...
@property (weak, nonatomic) IBOutlet UIImageView *imgSliderView;
@property (strong, nonatomic) IBOutlet ASValueTrackingSlider *slider1;
